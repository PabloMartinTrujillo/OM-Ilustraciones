                        ...
                        <div class="galeria-item-container">
                            ...
                            <div class="galeria-btns">
                                <?php if(Auth::check() == false): ?>
                                    <a class="enlace btn-modificar" href="<?php echo e(route("galeria.ver",$galeria->idGal)); ?>">
                                        <?php echo app('translator')->get("app.galeria_ver"); ?>
                                    </a>
                                <?php else: ?>
                                    <?php if(Auth::user()->tipoUsu == "admin"): ?>
                                        <a class="enlace btn-modificar" href="<?php echo e(route("galeria.modificar",$galeria->idGal)); ?>">
                                            <?php echo app('translator')->get("app.etq_modificar"); ?>
                                        </a>
                                    <?php else: ?>
                                        <a class="enlace btn-modificar" href="<?php echo e(route("galeria.ver",$galeria->idGal)); ?>">
                                            <?php echo app('translator')->get("app.galeria_ver"); ?>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH T:\xampp\htdocs\ProyectoFinal\resources\views/galeria/main.blade.php ENDPATH**/ ?>