...
<?php $__env->startSection("content"); ?>
    ...
    <div id="cuerpo">
        <form id="perfil-container" action="<?php echo e(route("usuario.guardarMod")); ?>" method="post" style="height:55vh;">
            ...
            <div class="perfil-datos">
                <label for="confirmPassword" class="perfil-datos-dato"><b><?php echo app('translator')->get("app.etq_contraUsu"); ?></b></label>
...
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH T:\xampp\htdocs\ProyectoFinal\resources\views/usuario/modificar.blade.php ENDPATH**/ ?>